...
namespace Wrapper.Prime
{
    internal class MPT_MP1_NTSC_U : Prime
    {
        ...
        protected const long OFF_BASEHEALTH = 0x805C5E4C;
        ...
        protected override long CWorldLayerState(uint world, uint area_id)
        {
            if (CGameState == 0)
                return 0;
            long result = GCMem.ReadUInt32(CGameState + OFF_CGAMESTATE_WORLDLAYERSTATE_ARRAY - 4);
            if (result == 0)
                return 0;
            for (int i = 0; i < 7; i++)
            {
                ...
                {
                    result = GCMem.ReadUInt32(result + 0x1C);
                    if (result == 0)
                        return 0;
                    if (area_id >= GCMem.ReadUInt32(result))
                        return 0;
                    result = GCMem.ReadUInt32(result + 0x8);
                    if (result == 0)
                        return 0;
        ...
        protected override long _IGT
        {
            get
            {
                if (CGameState == 0)
                    return 0;
                return (long)(GCMem.ReadFloat64(CGameState + OFF_CGAMESTATE_PLAYTIME + 8) * 1000);
            }
        }
        ...
        protected override int MorphState
        {
            ...
            set
            {
                if (CPlayer == 0)
                    return;
                GCMem.WriteInt32(CPlayer + OFF_CPLAYER_MORPHSTATE, value);
            }
        }
        ...
        public override uint CurrentSuitVisual
        {
            get
            {
                if (CPlayerState == 0)
                    return 0;
                return GCMem.ReadUInt32(CPlayerState + OFF_CURRENT_SUIT_VISUAL + 4);
            }
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteUInt32(CPlayerState + OFF_CURRENT_SUIT_VISUAL + 4, value);
            }
        }
        ...
        protected override int Missiles
        {
            get
            {
                if (CPlayerState == 0)
                    return 0;
                return GCMem.ReadInt32(CPlayerState + OFF_MISSILES + 4);
            }
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_MISSILES + 4, value);
            }
        }
        ...
        protected override int MaxMissiles
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_MAX_MISSILES + 4, value);
            }
        }
        ...
        protected override int PowerBombs
        {
            get
            {
                if (CPlayerState == 0)
                    return 0;
                return GCMem.ReadInt32(CPlayerState + OFF_POWERBOMBS + 4);
            }
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_POWERBOMBS + 4, value);
            }
        }
        ...
        protected override int MaxPowerBombs
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_MAX_POWERBOMBS + 4, value);
            }
        }
        ...
        protected override int MaxEnergyTanks
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_ENERGYTANKS_OBTAINED + 4, value);
            }
        }
        ...
        protected override bool HaveMorphBallBombs
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_MORPHBALLBOMBS_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveFlamethrower
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_FLAMETHROWER_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveChargeBeam
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_CHARGEBEAM_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveSuperMissile
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_SUPERMISSILE_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveGrappleBeam
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_GRAPPLEBEAM_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveIceSpreader
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_ICESPREADER_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveMorphBall
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_MORPHBALL_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveBoostBall
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_BOOSTBALL_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveSpiderBall
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_SPIDERBALL_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveGravitySuit
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_GRAVITYSUIT_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveVariaSuit
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_VARIASUIT_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HavePhazonSuit
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_PHAZONSUIT_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override bool HaveWavebuster
        {
            ...
            set
            {
                if (CPlayerState == 0)
                    return;
                GCMem.WriteInt32(CPlayerState + OFF_WAVEBUSTER_OBTAINED + 4, value ? 1 : 0);
            }
        }
        ...
        protected override void SetArtifact(int index, bool obtained)
        {
            ...
            {
                case 0:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_TRUTH_OBTAINED, obtained ? 1 : 0);
                    break;
                case 1:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_STRENGTH_OBTAINED, obtained ? 1 : 0);
                    break;
                case 2:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_ELDER_OBTAINED, obtained ? 1 : 0);
                    break;
                case 3:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_WILD_OBTAINED, obtained ? 1 : 0);
                    break;
                case 4:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_LIFEGIVER_OBTAINED, obtained ? 1 : 0);
                    break;
                case 5:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_WARRIOR_OBTAINED, obtained ? 1 : 0);
                    break;
                case 6:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_CHOZO_OBTAINED, obtained ? 1 : 0);
                    break;
                case 7:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_NATURE_OBTAINED, obtained ? 1 : 0);
                    break;
                case 8:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_SUN_OBTAINED, obtained ? 1 : 0);
                    break;
                case 9:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_WORLD_OBTAINED, obtained ? 1 : 0);
                    break;
                case 10:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_SPIRIT_OBTAINED, obtained ? 1 : 0);
                    break;
                case 11:
                    GCMem.WriteInt32(offset + OFF_ARTIFACT_OF_NEWBORN_OBTAINED, obtained ? 1 : 0);
                    break;
                default:
                    throw new Exception("There are no artifacts past the 12th artifact");
            }
