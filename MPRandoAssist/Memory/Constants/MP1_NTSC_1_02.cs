...
namespace Prime.Memory.Constants
{
    internal class MP1_NTSC_1_02 : _MP1
    {
        ...
        internal override int MorphBallBombs
        {
            get
            {
                if (CPlayerState == -1)
                    return 0;
                return Dolphin.ReadUInt8(GC.RAMBaseAddress + OFF_MORPHBALLBOMBS_COUNT);
            }
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(GC.RAMBaseAddress + OFF_MORPHBALLBOMBS_COUNT, (byte)value);
            }
        }

        internal override int MaxMorphBallBombs
        {
            get
            {
                return 3;
        ...
        internal override int Missiles
        {
            get
            {
                if (CPlayerState == -1)
                    return 0;
                return Dolphin.ReadUInt8(CPlayerState + OFF_MISSILES);
            }
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_MISSILES, (byte)value);
            }
        }
        ...
        internal override int MaxMissiles
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_MAX_MISSILES, (byte)value);
            }
        }

        internal override int PowerBombs
        {
            get
            {
                if (CPlayerState == -1)
                    return 0;
                return Dolphin.ReadUInt8(CPlayerState + OFF_POWERBOMBS);
            }
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_POWERBOMBS, (byte)value);
            }
        }
        ...
        internal override int MaxPowerBombs
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_MAX_POWERBOMBS, (byte)value);
            }
        }
        ...
        internal override bool HaveIceBeam
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_ICEBEAM_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveWaveBeam
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_WAVEBEAM_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HavePlasmaBeam
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_PLASMABEAM_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveMorphBallBombs
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_MORPHBALLBOMBS_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveFlamethrower
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_FLAMETHROWER_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveThermalVisor
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_THERMALVISOR_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveChargeBeam
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_CHARGEBEAM_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveSuperMissile
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_SUPERMISSILE_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveGrappleBeam
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_GRAPPLEBEAM_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveXRayVisor
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_XRAYVISOR_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveIceSpreader
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_ICESPREADER_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveSpaceJumpBoots
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_SPACEJUMPBOOTS_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveMorphBall
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_MORPHBALL_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveBoostBall
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_BOOSTBALL_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveSpiderBall
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_SPIDERBALL_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveGravitySuit
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_GRAVITYSUIT_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveVariaSuit
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_VARIASUIT_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HavePhazonSuit
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_PHAZONSUIT_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
        ...
        internal override bool HaveWavebuster
        {
            ...
            set
            {
                if (CPlayerState == -1)
                    return;
                Dolphin.WriteUInt8(CPlayerState + OFF_WAVEBUSTER_OBTAINED, (byte)(value ? 1 : 0));
            }
        }
